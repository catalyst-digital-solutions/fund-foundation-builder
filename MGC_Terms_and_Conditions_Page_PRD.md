# TERMS & CONDITIONS PAGE - LOVABLE PRD
**Version 1.0 | Mesa Group Consulting**  
...
- **URL Path:** /terms-and-conditions
- **Target Audience:** Existing and prospective Mesa Group Consulting clients
- **Primary Goal:** Legal compliance, transparency, client protection
- **Compliance Level:** High - Financial Services with CROA, CCPA, and California-specific requirements
- **Page Type:** Legal/Compliance Document
...
### Section Sequence
1. Hero Section (Legal Document Header)
2. Table of Contents Navigation
3. Full Terms & Conditions Content (17 Major Sections)
...
**Styling:** Tailwind CSS with MGC design tokens  
...
### Color Palette
- **MGC Yellow (#f9c65d):** Section number badges, accent highlights, links
- **MGC Gold (#bb9446):** Hover states, dark accents
- **MGC Tan (#E5D2AF):** Not used extensively (reserved for lighter sections if needed)
- **MGC Cream (#f8d899):** Hero gradient, warm section backgrounds
- **Gray Scale:** text-gray-900 (headings), text-gray-700 (body), text-gray-600 (muted)

### Typography
- **Hero H1:** text-4xl md:text-5xl lg:text-6xl font-bold
- **Section H2:** text-3xl md:text-4xl font-bold
- **Subsection H3:** text-xl font-bold
- **Body Text:** text-base leading-relaxed
- **Accent Words:** text-amber-600 (used sparingly in headings)

### Component Patterns
- **Section Numbers:** Amber badge with white text
- **Important Notices:** Colored callout boxes (blue for info, red for warnings, yellow for disclaimers, orange for critical legal)
- **Lists:** CheckCircle icons with text-green-600 for positive items
- **Contact Cards:** Gradient background with icon + text layout
- **Table of Contents:** Interactive button grid with hover states

---

## COMPLIANCE & DISCLAIMERS

This Terms & Conditions page includes comprehensive legal language covering:

✅ CROA compliance and consumer rights  
✅ California-specific notices (CCPA, Cal. Civ. Code 1789.3)  
✅ Mandatory arbitration agreement with opt-out provision  
...
- [x] All placeholder text replaced with actual content from Mesa Group Terms document
- [x] lucide-react icons used throughout (no emojis)
- [x] Responsive breakpoints implemented (mobile, tablet, desktop)
- [x] Accessibility features included (semantic HTML, proper heading hierarchy)
- [x] Compliance disclaimers prominently displayed
- [x] External links use target="_blank" rel="noopener noreferrer"
- [x] Table of contents with smooth scroll navigation
- [x] Visual hierarchy with numbered sections and color-coded callouts
- [x] Contact information clearly displayed
- [x] Dynamic copyright year: {new Date().getFullYear()}
- [x] Consistent MGC brand colors throughout
- [x] Professional legal document formatting
...
- **Sticky Table of Contents:** Quick access to all 17 major sections
- **Smooth Scrolling:** Click any TOC item to smoothly scroll to that section
- **Section Anchors:** Each section has a scroll-margin-top for proper positioning

### Visual Hierarchy
- **Numbered Section Badges:** Amber-colored badges with section numbers
- **Color-Coded Callouts:**
  - Blue: Information and notices
  - Red: Critical warnings and liability limitations
  - Yellow: Disclaimers and caution notices
  - Orange: Arbitration and legal requirements
  - Amber/Orange gradient: Contact information and acknowledgment

### Readability Features
- **Generous Spacing:** Proper padding and margins throughout
- **Clear Typography:** Large, readable fonts with proper line height
- **Organized Lists:** Bullet points with icons for easy scanning
- **Highlighted Key Terms:** Bold text for important legal terms
...
**Desktop (1024px+):**
- Maximum content width of 5xl (896px)
- 2-column TOC grid
...
**Professional Legal Document with Accessibility:**
- Clear, straightforward legal language
- Visual breaks to prevent wall-of-text
- Important sections highlighted for quick scanning
- Balance between legal protection and user-friendly presentation
- Prominent display of consumer rights (CROA, California)
- Transparent about limitations and client responsibilities

---

## FINAL NOTES

This Terms & Conditions page is designed to be:
1. **Legally Comprehensive:** Covers all required disclosures and protections
2. **User-Friendly:** Easy navigation and visual hierarchy
3. **Brand Consistent:** Maintains MGC's professional, warm aesthetic
4. **Mobile Responsive:** Fully functional on all device sizes
5. **Accessible:** Meets WCAG 2.1 AA standards
6. **Conversion-Focused:** Clear contact information for questions

**Next Steps for Implementation:**
1. Copy the JSX code into a new file: `src/pages/TermsAndConditions.tsx`
2. Import required components (Header, Footer)
3. Add route to your routing configuration
4. Update any "Insert phone number" placeholders
5. Test smooth scrolling and responsive layout
6. Review with legal counsel if needed
...
**For:** Mesa Group Consulting Website (v2 - Steve Neu Campaign)  
**Generated By:** Catalyst Digital Solutions