    ...
    <section className="bg-gradient-to-r from-amber-50 via-orange-50 to-amber-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <div className="text-4xl font-bold text-[#3e3e3e]">$15M+</div>
            <div className="text-sm text-gray-700 mt-2">Debt Consolidated</div>
          </div>
          
          <div>
            <div className="text-4xl font-bold text-[#3e3e3e]">$300</div>
            <div className="text-sm text-gray-700 mt-2">Avg. Monthly Savings</div>
          </div>
