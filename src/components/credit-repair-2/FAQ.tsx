      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4 mb-12">
          ...
          <FAQItem index={0} openFAQ={openFAQ} setOpenFAQ={setOpenFAQ} question="1. Is this legit or a scam?">
            ...
            <p>We're proud to serve clients in Spanish, English, and Punjabi. You can call us, visit us, or read reviews from real people we've helped. We're as real as it gets.</p>
          </FAQItem>
        ...
        <div className="space-y-4">
          ...
          <FAQItem index={10} openFAQ={openFAQ} setOpenFAQ={setOpenFAQ} question="11. What's included in the 1-on-1 financial coaching?">
            ...
            <ul className="list-disc pl-6 space-y-1 mb-4">
              ...
              <li>Bilingual support available (Spanish, English, Punjabi)</li>
