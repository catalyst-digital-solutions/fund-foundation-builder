...
const Footer = () => {
  ...
  return (
    <footer className="w-full">
      ...
      {/* 4-Column Footer — sunny background */}
      <div className="relative overflow-hidden">
        {/* Background: sunny SVG */}
        <img
          src="/sunny-background.svg"
          alt=""
          aria-hidden
          className="absolute inset-0 w-full h-full object-cover object-center pointer-events-none"
        />
        {/* Light warm overlay to soften gradient and ensure dark text legibility */}
        <div className="absolute inset-0 pointer-events-none" style={{ backgroundColor: 'rgba(255, 248, 220, 0.60)' }} />
              ...
              <div className="md:block">
                <Collapsible open={isCreditServicesOpen} onOpenChange={setIsCreditServicesOpen} className="md:hidden">
                  <CollapsibleTrigger className="flex items-center justify-between w-full text-left group mb-2">
                    ...
                    <ChevronDown className={`w-4 h-4 text-[#3e3e3e] transition-transform duration-200 md:hidden ${isCreditServicesOpen ? 'rotate-180' : ''}`} />
                  </CollapsibleTrigger>
                  <CollapsibleContent>
              ...
              <div className="md:block">
                <Collapsible open={isLendingOpen} onOpenChange={setIsLendingOpen} className="md:hidden">
                  <CollapsibleTrigger className="flex items-center justify-between w-full text-left group mb-2">
                    ...
                    <ChevronDown className={`w-4 h-4 text-[#3e3e3e] transition-transform duration-200 md:hidden ${isLendingOpen ? 'rotate-180' : ''}`} />
                  </CollapsibleTrigger>
                  <CollapsibleContent>
                    <ul className="space-y-2 text-sm mb-4">
              ...
              <div className="md:block">
                <Collapsible open={isProtectionOpen} onOpenChange={setIsProtectionOpen} className="md:hidden">
                  <CollapsibleTrigger className="flex items-center justify-between w-full text-left group mb-2">
                    ...
                    <ChevronDown className={`w-4 h-4 text-[#3e3e3e] transition-transform duration-200 md:hidden ${isProtectionOpen ? 'rotate-180' : ''}`} />
                  </CollapsibleTrigger>
                  <CollapsibleContent>
              ...
              <div className="md:block">
                <Collapsible open={isBusinessServicesOpen} onOpenChange={setIsBusinessServicesOpen} className="md:hidden">
                  <CollapsibleTrigger className="flex items-center justify-between w-full text-left group mb-2">
                    ...
                    <ChevronDown className={`w-4 h-4 text-[#3e3e3e] transition-transform duration-200 md:hidden ${isBusinessServicesOpen ? 'rotate-180' : ''}`} />
                  </CollapsibleTrigger>
                  <CollapsibleContent>
                    <ul className="space-y-2 text-sm mb-4">
              ...
              <div className="md:block">
                <Collapsible open={isResourcesOpen} onOpenChange={setIsResourcesOpen} className="md:hidden">
                  <CollapsibleTrigger className="flex items-center justify-between w-full text-left group mb-2">
                    ...
                    <ChevronDown className={`w-4 h-4 text-[#3e3e3e] transition-transform duration-200 md:hidden ${isResourcesOpen ? 'rotate-180' : ''}`} />
                  </CollapsibleTrigger>
                  <CollapsibleContent>
                    <ul className="space-y-2 text-sm">
                      <li>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <a href="https://www.facebook.com/mesagroupco" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#3e3e3e] flex items-center justify-center hover:bg-[#2c2c2c] transition-colors">
                    <Facebook className="w-4 h-4 text-[#f9c65d]" fill="currentColor" />
                  </a>
                  <a href="https://www.instagram.com/mesagroupco/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#3e3e3e] flex items-center justify-center hover:bg-[#2c2c2c] transition-colors">
                    <Instagram className="w-4 h-4 text-[#f9c65d]" />
                  </a>
                  <a href="https://www.tiktok.com/@mesagroupco" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#3e3e3e] flex items-center justify-center hover:bg-[#2c2c2c] transition-colors">
                    <svg className="w-4 h-4 text-[#f9c65d]" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                    </svg>
                  </a>
                  <a href="https://www.linkedin.com/company/106433329/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#3e3e3e] flex items-center justify-center hover:bg-[#2c2c2c] transition-colors">
                    <Linkedin className="w-4 h-4 text-[#f9c65d]" fill="currentColor" />
                  </a>
                  <a href="https://x.com/mesagroupco" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#3e3e3e] flex items-center justify-center hover:bg-[#2c2c2c] transition-colors">
                    <svg className="w-4 h-4 text-[#f9c65d]" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                  </a>
                  <a href="https://www.youtube.com/@MesaGroupCo" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-[#3e3e3e] flex items-center justify-center hover:bg-[#2c2c2c] transition-colors">
                    <Youtube className="w-4 h-4 text-[#f9c65d]" />
                  </a>
                </div>
              </div>
              ...
              <div>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-[#3e3e3e] text-sm">
                    <Star className="w-4 h-4 text-[#bb9446] fill-[#bb9446]" />
              ...
              <div className="pt-4">
                <p className="text-[#3e3e3e]/70 text-sm mb-1">A</p>
                ...
                <p className="text-[#3e3e3e]/70 text-sm mt-1">Website</p>
              </div>
            </div>
          </div>
