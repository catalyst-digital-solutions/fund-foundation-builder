...
import { Mail, Phone, MapPin, Clock, Facebook, Instagram, Linkedin, ChevronDown, Youtube } from 'lucide-react';
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex gap-3.5">
                <a href="https://www.facebook.com/mesagroupco" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#F9C65D] flex items-center justify-center hover:bg-[#bb9446] transition-colors">
                  <Facebook className="w-4 h-4 text-[#2C2C2C]" fill="currentColor" />
                </a>
                <a href="https://www.instagram.com/mesagroupco/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#F9C65D] flex items-center justify-center hover:bg-[#bb9446] transition-colors">
                  <Instagram className="w-4 h-4 text-[#2C2C2C]" />
                </a>
                <a href="https://www.tiktok.com/@mesagroupco" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#F9C65D] flex items-center justify-center hover:bg-[#bb9446] transition-colors">
                ...
                <a href="https://www.linkedin.com/company/106433329/admin/dashboard/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#F9C65D] flex items-center justify-center hover:bg-[#bb9446] transition-colors">
                  <Linkedin className="w-4 h-4 text-[#2C2C2C]" fill="currentColor" />
                </a>
                <a href="https://x.com/mesagroupco" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#F9C65D] flex items-center justify-center hover:bg-[#bb9446] transition-colors">
                  <svg className="w-4 h-4 text-[#2C2C2C]" fill="currentColor" viewBox="0 0 24 24">
