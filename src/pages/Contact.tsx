          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Get Your <span className="text-amber-600">Free Credit Report Analysis</span> & Personalized Financial Strategy
              </h1>
          ...
          <div className="bg-gray-900 rounded-3xl p-12 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
                In-Office Meeting — Personalized <span className="text-amber-600">Financial Guidance</span>. Face-to-Face <span className="text-amber-600">Expert Consultations</span> in Our Bakersfield Office.
              </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900">
              Subscribe to our <span className="text-amber-600">Newsletter</span> for free credit tips.
            </h2>
